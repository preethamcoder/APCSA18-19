...
public class BaseConvert
{
 ...
 Scanner scan = new Scanner(System.in);
      ...
      System.out.println("Becasue you chose base "+base+", the maximum number you can input is "+(Math.pow(base,4)-1));
      ...
      String numberInBase = (String.valueOf(place3)+String.valueOf(place2)+String.valueOf(place1)+String.valueOf(place0));
      // Print the result (see notes in lab)
      System.out.println(base10Num+" in base "+base+" is "+numberInBase+".");
      scan.close();
    }
}
